...
$(post_wrap).after('<p class="inside"><span class="count_title count_wrap"></span><strong>文字</strong> ※全角28文字以内推奨</p>');
...
$(post_wrap_page).after('<p class="inside"><span class="count_title count_wrap"></span><strong>文字</strong> ※全角28文字以内推奨</p>');
...
//$(post_wrap_lp).after('<p class="inside"><span class="count_title count_wrap"></span><strong>文字</strong> ※全角28文字以内推奨</p>');
...
$( editor_before ).find("#postdivrich").before('<div id="editor-before" class="postbox"><h3 class="hndle">SEO効果を高める投稿方法</h3><div class="inside"><small>以下に本文を入力していきましょう。ユーザーに大きな価値を与える良質なコンテンツを作りましょう。コンテンツが良質でさえあれば、自然にSEOもソーシャルメディアも攻略することができます。また見出しの使い方や画像のALTタグの設定方法によってSEOの効果は変わってきます。『<a href="http://bazubu.com/contet-seo-18508.html" target="_blank">コンテンツSEOの効果と7つの手順</a>』と『<a href="http://bazubu.com/wordpress-post-15790.html" target="_blank">WordPressの投稿方法</a>』を参考にして下さい。</small></div></div>');
 $( editor_before ).find('#postimagediv').find('#set-post-thumbnail').before('<div class="inside"><small>メイン画像を設定しましょう。『画像をアップロードする』ボタンを押して、画像を選んで下さい。<br>このテンプレートでは、1200px x 650pxi以上の画像が最も適しています</small></div>');
...
$( editor_before_lp ).find('#postdivrich').before('<div id="editor-before" class="postbox"><h3 class="hndle">コンテンツの作成</h3><div class="inside"><small>以下に本文を入力していきましょう。リストタグなどを効果的に使用して、プレゼントの内容が明確に伝わる説明文を作りましょう。<br>詳しくは、『<a href="" target="_blank">反応率の高いランディングページの作り方</a>』を参考にして下さい。</small></div></div>');
 $( editor_before_lp ).find('#postimagediv').find('#set-post-thumbnail').before('<div class="inside"><small>リスト取得ランディングページのメイン画像を設定しましょう。『画像をアップロード』ボタンを押して、画像を選んで下さい。<br>このテンプレートでは、○○○px x ○○○px の画像が最も適しています</small></div>');
...
$( editor_before_cta ).find('#postdivrich').before('<div id="editor-before" class="postbox"><h3 class="hndle">コンテンツの作成</h3><div class="inside"><small>以下に本文を入力していきましょう。リストタグなどを効果的に使用して、プレゼントの内容が明確に伝わる説明文を作りましょう。<br>詳しくは、『<a href="" target="_blank">反応率の高いCTAの作り方</a>』を参考にして下さい。</small></div></div>');
...
if($("#post_type").val() == 'page'){
    ...
    if($("#page_template").val() == 'default'){
      ...
      $("#bzb_post_asset-hide").removeAttr("checked");
      $("#bzb_post_asset").hide("fast");
      ...
      $("#commentsdiv-hide").removeAttr("checked");
      $("#commentsdiv").hide("fast");
