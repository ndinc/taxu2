...
?>
  ...
  <tr class="form-field">
    <th><label for="bzb_meta_keywords">カカテゴリーページ用メタキーワード</label></th>
  ...
  <tr class="form-field">
    ...
    <td>
      ...
      <input class="cmb_option" type="checkbox" name="Cat_meta[bzb_meta_robots][0]" id="bzb_meta_robots1" value="noindex"  <?php echo (isset($metarobots_array) && is_array($metarobots_array) && in_array('noindex', $metarobots_array)) ? 'checked' : '';?> /> <label for="bzb_meta_robots1">noindex</label></li>
      <li>
      <input type="hidden" name="Cat_meta[bzb_meta_robots][1]" value="">
      <input class="cmb_option" type="checkbox" name="Cat_meta[bzb_meta_robots][1]" id="bzb_meta_robots2" value="nofollow" <?php echo (isset($metarobots_array) && is_array($metarobots_array) && in_array('nofollow', $metarobots_array)) ? 'checked' : '';?>  /> <label for="bzb_meta_robots2">nofollow</label></li>
      </ul>
    </td>
  </tr>
  <tr class="form-field">
    ...
    <td>
      <?php $bzb_meta_content = '';
      ?>
      <?php wp_editor( stripslashes($cat_meta['bzb_meta_content']), 'bzb_meta_content', array( 'media_buttons'=>true, 'textarea_name'=>'Cat_meta[bzb_meta_content]','textarea_rows'=>10,'tiny_mce'=>true) ); ?>
    </td>
  </tr>
