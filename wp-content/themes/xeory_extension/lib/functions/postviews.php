...
### Class: WP-PostViews Widget
 class WP_Widget_PostViews_bzb extends WP_Widget {
  // Constructor
  function WP_Widget_PostViews_bzb() {
    $widget_ops = array('description' => '人気記事をページビュー数付で表示します');
    $this->WP_Widget('views', __('人気記事一覧', 'wp-postviews'), $widget_ops);
  }
...
add_action('load-themes.php', 'pre_views_activation');
