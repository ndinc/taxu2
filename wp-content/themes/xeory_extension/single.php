  ...
  <div id="main" <?php bzb_layout_main(); ?> role="main" itemprop="mainContentOfPage" itemscope="itemscope" itemtype="http://schema.org/Blog">
    ...
    <aside class="post-author" itemprop="author" itemscope="itemscope" itemtype="http://schema.org/Person">
      <div class="clearfix row">
        <div class="post-author-img gr2">
          <div class="inner">
            <?php $org_avatar = get_option('original_avatar');
              if( $org_avatar ){
                echo '<img src="'.get_option('original_avatar').'">';
              }else{
                echo '<img src="'.get_template_directory_uri().'/lib/images/masman.png" alt="masman" width="100" height="100" />';
              } ?>
          </div>
        </div><!-- /post-author-img -->
        <div class="post-author-meta gr10">
          <h4 itemprop="name"><span>著者 </span><?php the_author_meta('display_name'); ?> </h4>
          <p itemprop="discription"><?php the_author_meta('description');?></p>
        </div>
      </div>
    </aside>
